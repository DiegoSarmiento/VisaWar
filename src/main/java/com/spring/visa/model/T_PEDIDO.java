...
@NamedStoredProcedureQueries({
    @NamedStoredProcedureQuery(
            ...
            parameters = {
              @StoredProcedureParameter(mode=ParameterMode.IN, name="PIN_NU_TOTAL_VALOR", type=int.class),
    ...
    @NamedStoredProcedureQuery(
            ...
            parameters = {
              @StoredProcedureParameter(mode=ParameterMode.IN, name="PIN_NU_PEDIDO", type=int.class),
              @StoredProcedureParameter(mode=ParameterMode.OUT, name="POUT_CUR_PEDIDO", type=void.class),
              }),
    @NamedStoredProcedureQuery(
    		name = "SP_U_PEDIDO",
...
public class T_PEDIDO {
    ...
    private long NU_PEDIDO;
    private long NU_TOTAL_VALOR;
	...
	public void setNU_PEDIDO(long nU_PEDIDO) {
		NU_PEDIDO = nU_PEDIDO;
	}
	public long getNU_TOTAL_VALOR() {
		return NU_TOTAL_VALOR;
	}
	public void setNU_TOTAL_VALOR(long nU_TOTAL_VALOR) {

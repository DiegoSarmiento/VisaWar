...
@NamedStoredProcedureQuery(
        ...
        parameters = {
          ...
          @StoredProcedureParameter(mode=ParameterMode.IN, name="PIN_NU_PRECIO", type=int.class),
          @StoredProcedureParameter(mode=ParameterMode.IN, name="PIN_NU_CANTIDAD", type=int.class),
          @StoredProcedureParameter(mode=ParameterMode.IN, name="PIN_NU_TOTAL", type=int.class),
...
public class T_PEDIDO_DETALLE {
	...
	private int NU_PRECIO;
	private int NU_CANTIDAD;
	private int NU_TOTAL;
	...
	public int getNU_PRECIO() {
		return NU_PRECIO;
	}


	public void setNU_PRECIO(int nU_PRECIO) {
		NU_PRECIO = nU_PRECIO;
	}
	...
	public int getNU_TOTAL() {
		return NU_TOTAL;
	}


	public void setNU_TOTAL(int nU_TOTAL) {
		NU_TOTAL = nU_TOTAL;
	}
